...
class PhoneTest {
    ...
    void givenValidNumber_whenInstantiate_thenNotThrows(String number) {
        assertDoesNotThrow(() -> new Phone(phoneType, number));
    }

    @ParameterizedTest
    @ValueSource(strings = {"35-9221-1000", "66-78899-8899", "23-7777-8888", "21-7977-8888", "35-7000-1234", "900-123-1234", "4003-9004", "", "abc", "0"})
    void givenInvalidNumber_whenInstantiate_thenThrows(String number) {
        assertThrows(DomainEntityValidationException.class, () -> new Phone(phoneType, number));
    }

    @Test
    void givenNullNumber_whenInstantiate_thenThrows() {
        assertThrows(DomainEntityValidationException.class, () -> new Phone(phoneType, null));
    }

    @Test
    void givenNullPhoneType_whenInstantiate_thenThrows() {
        assertThrows(DomainEntityValidationException.class, () -> new Phone(null, "35-3221-1000"));
    }

    @Test
    void givenPhoneType_whenGet_thenReturnSamePhoneType() {
        phoneType = new PhoneType("some type");
        Phone phone = new Phone(phoneType, "35-3221-1000");
